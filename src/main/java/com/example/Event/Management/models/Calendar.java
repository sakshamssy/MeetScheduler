...
public class Calendar{
    ...
    public Map<LocalDate, Map<LocalTime, Integer>>  generateCalendar( LocalDate currentDate) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            Map<LocalTime, Integer> timeSlots = new LinkedHashMap<>();
    ...
    public void setcal(Map<LocalDate, Map<LocalTime, Integer>> events){
        this.events = events;
    }
